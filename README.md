...
1. **Storing raw webhook payload** - Only store required fields!
2. **Not handling duplicates** - Use unique index on request_id
3. **Not converting to UTC** - Always store timestamps in UTC
4. **Re-rendering displayed events** - Track shown event IDs on frontend
5. **Blocking main thread** - Use async patterns for polling

## 🎯 Interview Tips

- **Clean Code:** Use meaningful variable names, docstrings, and type hints
- **Modular Design:** Separate routes, services, and models
- **Error Handling:** Always use try/except with proper error messages
- **Environment Config:** Never hardcode sensitive data
- **Idempotency:** Handle duplicate webhooks gracefully

## 📝 License

MIT License - Built for hiring assessment purposes.
